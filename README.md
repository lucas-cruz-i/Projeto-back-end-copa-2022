...
- 🔀 Gerenciar rotas da API (GET, POST, PUT, DELETE)  
...
- Banco de Dados (MySQL ou outro utilizado no projeto)  
...
📌 Trabalhar com criação de API REST

📌 Implementar operações CRUD completas

📌 Integrar Node.js com banco de dados
